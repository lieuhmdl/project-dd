...
const SEED_CARDS = [
  base("Unit", { name: "Julius XI, Grand General", provisions: "4", mana: "0", race: "Human", klass: "Paladin", position: "Frontline", rarity: "Legendary", keywords: ["Guard", "Swift"], attack: "3", health: "6", strike: "Deal 3.",
    abilities: ["Preach - 2 Mana - Empowers one friendly Human unit. (Per Turn)", "Crusader Strike - 1 Prov 1 Mana - Imbues Julius XI's blade with holy power, dealing 3 damage and 1 burn damage for 2 turns (does not stack)."] }),
  base("Ancient Legend", { name: "Example Legend :P", provisions: "5", mana: "0", race: "Human", klass: "Paladin", position: "Frontline", rarity: "Legendary", keywords: ["Guard", "Rally X"], attack: "0", health: "8",
    abilities: ["Banner (P2): ally units of the Faith (Clerics and Paladins) gain a +0/+1 counter."], passive: "Your party may include 2\u20134 Tribes with no Tension." }),
