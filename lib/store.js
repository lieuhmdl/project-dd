...
const SEED_RACES = [
  { name: "Human",    signature: "Paladin",   classes: ["Paladin","Cleric","Ranger","Monk","Druid"],             lean: "Flexible",         allies: 'Everyone ("second-best friends")', rivals: "None" },
  { name: "Dwarf",    signature: "Fighter",   classes: ["Fighter","Cleric","Monk"],                              lean: "Frontline",        allies: "Gnome (best), Halfling, Human; Elf in war", rivals: "Half-orc; friction with Elf" },
  { name: "Elf",      signature: "Wizard",    classes: ["Wizard","Ranger","Cleric","Druid"],                     lean: "Backline",         allies: "Half-elf; Dwarf in war; gracious to all", rivals: "Half-orc" },
  { name: "Gnome",    signature: "Bard",      classes: ["Bard","Cleric","Druid"],                                lean: "Backline",         allies: "Dwarf (best), Halfling", rivals: "Goblinoids / giants" },
  { name: "Half-elf", signature: "Sorcerer",  classes: ["Sorcerer","Ranger","Druid","Cleric"],                  lean: "Flexible / Backline", allies: "Elf, Human, Dwarf, Gnome, Halfling", rivals: "Half-orc (mild)" },
  { name: "Half-orc", signature: "Barbarian", classes: ["Barbarian","Ranger"],                                  lean: "Frontline",        allies: "Human; fellow outsiders", rivals: "Dwarf, Elf" },
  { name: "Halfling", signature: "Rogue",     classes: ["Rogue","Cleric","Druid","Monk"],                       lean: "Flexible",         allies: "Everyone, especially Human", rivals: "None" },
];

function defaultDoc() {
  return { cards: SEED_CARDS, keywords: SEED_KEYWORDS, users: [], writeToken: "changeme", races: SEED_RACES, changelog: [] };
}
